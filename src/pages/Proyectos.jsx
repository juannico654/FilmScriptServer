      ...
      {confirm && (
        ...
        >
          ...
          >
            ...
            >
              Esta acción eliminará el proyecto y todas sus escenas. No se puede
              deshacer.
            </div>
            <div className="sc-modal-acts" style={{ justifyContent: "center" }}>
              <button className="btn-red" onClick={() => handleDelete(confirm)}>
                Sí, eliminar
              </button>
